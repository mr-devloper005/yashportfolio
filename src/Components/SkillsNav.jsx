...
function SkillsNav() {
  return (
    <>
    <div className='w-96 md:w-full h-1/2 rounded-4xl md:rounded-none mr-20 bg-gradient-to-b ml-3 md:ml-0 mt-5 from-stone-800 via-neutral-950 to-neutral-800'>
      ...
      <div className='w-full h-48 flex flex-wrap  md:flex-nowrap justify-evenly items-center'>
        <img src="htmlpng.png" className='w-16 md:w-28 m-2' alt="" />
        <img src="csspng.png" className='w-16 md:w-28 m-2' alt="" />
        <img src="jspng.png" className='w-16 md:w-28 m-2' alt="" />
        <img src="reactpng.png" className='w-16 md:w-28 m-2' alt="" />
