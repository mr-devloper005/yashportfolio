...
function Home() {
  return (
    <div id='home' className='min-h-screen w-screen flex flex-col'>
  {/* Empty div for spacing */}
  <div className='flex-grow'></div>

  {/* Main Content */}
  <div className='flex-grow w-full flex justify-evenly items-center flex-col gap-4 sm:gap-6 md:gap-7'>
    <h1 className='text-white lobster-regular font-extrabold text-3xl sm:text-4xl md:text-6xl'>
      Hey! I'm <span className='col'>Y</span>ash<span className='col'> N</span>ihalani
    </h1>
    <h2 className='text-white font-extrabold lobster-regular text-3xl sm:text-4xl md:text-7xl'>
    ...
    <h4 className='text-white lobster-regular tracking-wide text-2xl sm:text-3xl md:text-4xl xl:text-5xl text-center px-4 md:px-20 xl:px-40'>
    ...
    <button
      ...
      className='p-4 md:p-5 px-8 md:px-10 bg-rose-600 rounded-3xl active:scale-90 text-white text-2xl md:text-3xl font-extrabold cursor-pointer'
    >
      Hire Me
    </button>
  </div>
  ...
  {/* Social Links */}
  <div className='flex-grow w-full flex justify-center relative items-center'>
    <SocialLinks />
  </div>
</div>
